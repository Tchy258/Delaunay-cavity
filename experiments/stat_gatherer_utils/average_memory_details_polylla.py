...
for j in vertex_amount:
    current = {}
    current[f'memory_max_edges'] = []
    current[f'memory_frontier_edges'] = []
    current[f'memory_seed_edges'] = []
    current[f'memory_seed_barrier_edge_tip_mark'] = []
    current[f'memory_triangle_list'] = []
    current[f'memory_edges_input'] = []
    current[f'memory_edges_output'] = []
    current[f'memory_vertices_input'] = []
    current[f'memory_vertices_output'] = []
    current[f'memory_total'] = []
    for s in seeds:
